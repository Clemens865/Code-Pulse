...
export function uninstall(opts: { purge?: boolean } = {}): void {
  ...
  console.log(
    "[uninstall] note: repos may contain a .claude/.pulse-session sentinel file; it is inert without the hook and safe to delete.",
  );
