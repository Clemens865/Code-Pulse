...
Both live behind OAuth at `app.code-pulse.dev` (working title). The product also ships a CLI and a hook script — those are out of scope for this design pass except where they need onboarding screens.
