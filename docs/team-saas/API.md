...
- **Base URL**: `https://api.code-pulse.dev/v1` (production), `http://localhost:8787/v1` (local).
...
Cookie attributes: `HttpOnly; Secure; SameSite=Lax; Domain=.code-pulse.dev; Max-Age=2592000`.
...
```json
{
  "type": "https://docs.code-pulse.dev/errors/redaction_policy_violation",
