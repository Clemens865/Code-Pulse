...
**Claude Pulse Team is the middleware layer that captures every
...
- `@claude-pulse-team/hook-claude` *(current)* — Claude Code
- `@claude-pulse-team/hook-cursor` *(planned, Phase 2)* — Cursor
- `@claude-pulse-team/hook-cody` *(planned, Phase 3)* — Sourcegraph Cody
- `@claude-pulse-team/hook-aider` *(planned, Phase 3)* — Aider CLI
